...
export declare class UsersController {
    ...
    constructor(usersService: UsersService, dailyChallengeService: DailyChallengeService, configService: ConfigService);
    ...
    getTodayDailyChallenge(): Promise<import("mongoose").Document<unknown, {}, import("./schemas/daily-challenge.schema").DailyChallengeDocument, {}, import("mongoose").DefaultSchemaOptions> & import("./schemas/daily-challenge.schema").DailyChallenge & import("mongoose").Document<import("mongoose").Types.ObjectId, any, any, Record<string, any>, {}> & Required<{
        _id: import("mongoose").Types.ObjectId;
    }> & {
        __v: number;
    } & {
    ...
    completeDailyChallenge(id: string, challengeId: string, req: any): Promise<{
        message: string;
        streak: number;
    ...
    getUserDailyChallengeStats(id: string): Promise<{
        currentStreak: number;
        longestStreak: number;
    ...
    createDailyChallengeManual(): Promise<void>;
}
